!function (a, b) {
    a.SCS = {version: "1.0.0"}, SCS.defaults = {
        ...
        }), c += '</div><div class="scs_btns"><div class="scs_btn_span"></div><div class="scs_btn scs_btn_cancel">取消</div><div class="scs_btn scs_btn_ok">确定</div></div></div></div></div>', b("#cascade_scroll_selects").remove(), b("body").append(c);
